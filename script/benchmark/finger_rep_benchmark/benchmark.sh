# Generate Grippers
python -m script.benchmark.finger_rep_benchmark.generate_gripper --num_finger 4 --variance_scale 2.0 --max_segment_count 10 --hidden_dim 10 --num_grippers 100 --gripper_dir data/grippers
