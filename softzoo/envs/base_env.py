...
from ..utils.config_utils import merge_cfg, set_cfg_attr
from ..utils.const import F_DTYPE,I_DTYPE

@ti.data_oriented
class BaseEnv(Env):
    def __init__(
        self, cfg_file:str, out_dir:str, device:Optional[Literal['numpy','torch_cpu','torch_gpu']] = 'numpy',
        ...
        cfg:SimulatorConfig = merge_cfg(default_cfg, cfg_file)
        ...
        # region Design Space Initialization
        ...
        cfg.ENVIRONMENT.design_space_config = merge_cfg(default_design_space_cfg, cfg.ENVIRONMENT.design_space_config)
        ...
        if cfg.ENVIRONMENT.design_space == 'vbr':
            ...
            raise ValueError(f'Unrecognized design space API {cfg.ENVIRONMENT.design_space}')
        ...
        # region Objective Initialization
        ...
        self.action_space = spaces.Box(
            low=-cfg.ENVIRONMENT.actuation_strength,
    ...
    def step(self, action, fixed_v):
        self.sim.step(action, self.frame_dt,fixed_v)
        obs = self.get_obs()
