...
from ..utils.general_utils import Enum, recursive_getattr
from ..utils.taichi_utils import TiDeviceInterface
...
class TaichiSim:
    def __init__(
        ...
        device:Optional[Union[Literal['numpy','torch_cpu','torch_gpu'],TiDeviceInterface]] = 'numpy',
    ...
    def step(self, action, frame_dt,fixed_v):
        assert self.is_initialized, 'Should call initialize() first before doing anything.'
            
        # Step solver
        self.solver.step(action, frame_dt,fixed_v)
    ...
    # region Get/Set Wrapper
    def apply(self, mode:Literal['get','set'], tensor_field_name: str, **kernel_kwargs):
    ...
    # region Get/Set Tensor Field Kernel
