...
from ..config_dataclass import DefaultStaticConfig
...
# Flat surface
__C.FLATSURFACE = CN()
__C.FLATSURFACE.type = 'Static.FlatSurface'
...
__C.FLATSURFACE.dampen_coeff = 0.5
...
__C.TERRAIN.dampen_coeff = 0.5


def get_cfg_defaults(item_type='DEFAULT')->Union[DefaultStaticConfig,CN]:
