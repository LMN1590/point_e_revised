...
from ..config_dataclass import PrimitiveBaseConfig
...
### Default
__C.DEFAULT = CN()
__C.DEFAULT.type = 'Primitive.Undefined'
...
def get_cfg_defaults(item_type='DEFAULT')->Union[PrimitiveBaseConfig,CN]:
