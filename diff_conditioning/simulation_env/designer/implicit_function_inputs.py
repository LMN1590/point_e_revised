...
class ImplicitFunctionInputs:
    '''
    Provide inputs for neural network. Inputs included:
    x,y,z,
    dxy,dyz,dzx,
    dxyz
    And the sdf of a bunch of meshes to be used as priors
    '''
    
    def __init__(self, env:BaseEnv, coord_input_names:List[str], seed_meshes:List[str]=[]):
        self.env = env
