...
class PointCloud:
    ...
    def random_sample(self, num_points:int, **subsample_kwargs) -> "PointCloud":
        ...
        """
        if len(self.coords) <= num_points: return self
    ...
    def subsample(self, indices: np.ndarray, average_neighbors: bool = False) -> "PointCloud":
        """
        The Subsample method returns a new PointCloud that averages the channels of each chosen point nearest neighbor to smooth channel data.
        """
